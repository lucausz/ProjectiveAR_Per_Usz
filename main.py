...
# Display the board
## TODO: use projector and game methods
...
while key!=27 and game.game_over==False:
    ...
    if game.isInTheBoard(move):
        ...
        if d<100 and time.time()-t>3:
            ...
            # Display the board
            ## TODO
            proj.draw(game.getBoard()) # <-- MET À JOUR L'AFFICHAGE

            # Wait 1s before taking the reference frame
            ## TODO
            cv.waitKey(1000) # <-- ATTEND 1 SECONDE
            core.storeRefFrame() # <-- REPREND LA RÉFÉRENCE
