...
# TicTacToe related constants to create the board image (in board space units)
SQUARE_SIZE = 100
LINE_SIZE = 5
EDGE_SIZE = (int((BOARD_MAX_SIZE[0]-3*SQUARE_SIZE)/2), int((BOARD_MAX_SIZE[1]-3*SQUARE_SIZE)/2))


# Playing area corners (calculated from EDGE_SIZE and BOARD_MAX_SIZE)
PLAYING_AREA_PT1 = (EDGE_SIZE[0], EDGE_SIZE[1])
PLAYING_AREA_PT2 = (BOARD_MAX_SIZE[0] - EDGE_SIZE[0], BOARD_MAX_SIZE[1] - EDGE_SIZE[1])